...
class ServerStorage:
    ...
    def __init__(self, path):
        ...
        self.registry = registry()  # Экземпляр registry
        ...
        # Создаём отображения
        self.registry.map_imperatively(self.AllUsers, users_table)
        self.registry.map_imperatively(self.ActiveUsers, active_users_table)
